	...
	?>
		...
		<?if($bCatalog){?>
			...
			<?/*?><tr>
				...
				<td>
					<input type="checkbox" name="SETTINGS_DEFAULT[CALCULATE_PRICE]" value="Y" <?if($SETTINGS_DEFAULT['CALCULATE_PRICE']=='Y'){echo 'checked';}?>>
					&nbsp;
					(<a href="javascript:void(0)" onclick="EProfile.OpenCalcPriceForm(this)" class="kda-ie-link2window kda-ie-link2window_grey"><?echo GetMessage("KDA_IE_CALCULATE_PRICE_WINDOW"); ?></a>)
				</td>
			</tr><?*/?>
