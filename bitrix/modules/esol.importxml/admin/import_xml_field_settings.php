...
if(isset($_POST['POSTEXTRA']))
{
	...
	$fName = htmlspecialcharsbx($_GET['field_name']);
...
{
	$arExtra = array();
	\Bitrix\EsolImportxml\Extrasettings::HandleParams($arExtra, array(array('CONVERSION'=>$_POST['CONVERSION'], 'EXTRA_CONVERSION'=>$_POST['EXTRA_CONVERSION'])));
	...
	<table width="100%">
		...
		<?if($bPropList){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[PROPLIST_PROPS_SEP]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[PROPLIST_PROPVALS_SEP]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsbx($val)?>" size="3">
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[PROPLIST_CREATE_NEW]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[NOT_CHANGE_OLD_VALUES]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bIblockElement || $bProductGift){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[REL_ELEMENT_FIELD]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$val = '';
		...
		<?if($bIblockSection){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[REL_SECTION_FIELD]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$val = '';
					if(is_array($PEXTRASETTINGS))
					{
		...
		<?if($bDirectory && !empty($arHLFields)){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[HLBL_FIELD]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$val = '';
					if(is_array($PEXTRASETTINGS))
					{
		...
		<?if($bVideo){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[VIDEO_WIDTH]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[VIDEO_HEIGHT]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
		...
		<?if($bUid){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[UID_SEARCH_SUBSTRING]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bSectionUid){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[SECTION_UID_SEPARATED]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[SECTION_SEARCH_IN_SUBSECTIONS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[SECTION_SEARCH_WITHOUT_PARENT]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($field=="IE_SECTION_PATH"){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[SECTION_PATH_SEPARATOR]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[SECTION_PATH_SEPARATED]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bCanUseForSKUGenerate){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[USE_FOR_SKU_GENERATE]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($isOffer){?>
			<?/*if($bOfferUid){?>
				<tr>
					...
					<td class="adm-detail-content-cell-r">
						<?
						$fName = htmlspecialcharsbx($_GET['field_name']).'[SEARCH_SINGLE_OFFERS]';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
						?>
						<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bMultipleProp || $bMultipleField){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[CHANGE_MULTIPLE_SEPARATOR]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					$fName2 = htmlspecialcharsbx($_GET['field_name']).'[MULTIPLE_SEPARATOR]';
		...
		<?if($bMultipleProp){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[MULTIPLE_SAVE_OLD_VALUES]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName1 = htmlspecialcharsbx($_GET['field_name']).'[MULTIPLE_FROM_VALUE]';
					$fNameEval1 = strtr($fName1, array("["=>"['", "]"=>"']"));
					eval('$val1 = $P'.$fNameEval1.';');
					
					$fName2 = htmlspecialcharsbx($_GET['field_name']).'[MULTIPLE_TO_VALUE]';
					$fNameEval2 = strtr($fName2, array("["=>"['", "]"=>"']"));
					eval('$val2 = $P'.$fNameEval2.';');
					?>
		...
		<?if($bTextHtml){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[TEXT_HTML]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$val = '';
					if(is_array($PEXTRASETTINGS))
					{
		...
		<?if($bIblockElementSet){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[CHANGE_LINKED_IBLOCK]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					$fName2 = htmlspecialcharsbx($_GET['field_name']).'[LINKED_IBLOCK]';
					$fNameEval2 = strtr($fName2, array("["=>"['", "]"=>"']"));
					eval('$val2 = $P'.$fNameEval2.';');
		...
		<?if($field=='IE_CREATED_BY'){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[USER_UID]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$val = '';
					if(is_array($PEXTRASETTINGS))
					{
		...
		<tr>
			<td class="esol-ix-settings-margin-container" colspan="2" id="esol-ix-conv-wrap0">
				<?
				$fName = htmlspecialcharsbx($_GET['field_name']).'[CONVERSION]';
				$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
				$arVals = array();
				if(is_array($PEXTRASETTINGS))
				{
		...
		<?if(true /*!$bVariable*/){?>
			...
			<tr>
				<td class="esol-ix-settings-margin-container" colspan="2">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[CONDITIONS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$arVals = array();
					if(is_array($PEXTRASETTINGS))
					{
		...
		<?if($bPrice){
			$fName = htmlspecialcharsbx($_GET['field_name']).'[MARGINS]';
			$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
			eval('$val = $P'.$fNameEval.';');
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[PRICE_ROUND_RULE]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<select name="<?=$fName?>">
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[PRICE_ROUND_COEFFICIENT]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<?if($field!="ICAT_PURCHASING_PRICE"){?>
				<tr>
					...
					<td class="adm-detail-content-cell-r">
						<?
						$fName = htmlspecialcharsbx($_GET['field_name']).'[PRICE_USE_EXT]';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
						$priceExt = $val;
						?>
				...
				<tr id="price_ext" <?if($priceExt!='Y'){echo 'style="display: none;"';}?>>
					...
					<td class="adm-detail-content-cell-r">
						<?
						$fName = htmlspecialcharsbx($_GET['field_name']).'[PRICE_QUANTITY_FROM]';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
						?>
						...
						&nbsp; &nbsp;
						<?
						$fName = htmlspecialcharsbx($_GET['field_name']).'[PRICE_QUANTITY_TO]';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
						?>
				...
				<tr>
					...
					<td class="adm-detail-content-cell-r">
						<?
						$fName = htmlspecialcharsbx($_GET['field_name']).'[EXT_UPDATE_FIRST]';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
						?>
		...
		if($bPicture)
		{
			...
			{
				$fName = htmlspecialcharsbx($_GET['field_name']).'[PICTURE_PROCESSING]['.$field.']';
				$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
				$arFields[$field] = array(
					'NAME' => htmlspecialcharsbx($_GET['field_name']).'[PICTURE_PROCESSING]['.$field.']',
		...
		<?if($field!='SECTION_SEP_NAME'){?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[UPLOAD_VALUES]';
					$fName2 = htmlspecialcharsbx($_GET['field_name']).'[UPLOAD_KEYS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$fNameEval2 = strtr($fName2, array("["=>"['", "]"=>"']"));
					$arVals = array();
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[NOT_UPLOAD_VALUES]';
					$fName2 = htmlspecialcharsbx($_GET['field_name']).'[NOT_UPLOAD_KEYS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$fNameEval2 = strtr($fName2, array("["=>"['", "]"=>"']"));
					$arVals = array();
					if(is_array($PEXTRASETTINGS)) eval('$arVals = $P'.$fNameEval.';');
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[USE_FILTER_FOR_DEACTIVATE]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			<tr>
				<td class="esol-ix-settings-margin-container" colspan="2">
					...
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[FILTER_EXPRESSION]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
		...
		<?if(!$bVariable){?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r" style="min-width: 30%;">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[SET_NEW_ONLY]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r" style="min-width: 30%;">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[NOT_TRIM]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			<?if(!$bMultipleProp && !$bMultipleField){?>
				<tr>
					...
					<td class="adm-detail-content-cell-r" style="min-width: 30%;">
						<?
						$fName = htmlspecialcharsbx($_GET['field_name']).'[INDEX_LOAD_VALUE]';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
						?>
						<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsbx($val)?>" size="3">
		...
		<?if($bExtLink){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[LOAD_BY_EXTLINK]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bChangeable){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[LOADING_MODE]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<select name="<?=$fName?>">
		...
		<tr>
			<td class="esol-ix-settings-margin-container" colspan="2">
				...
				<?
				$fName = htmlspecialcharsbx($_GET['field_name']).'[FIELD_NOTE]';
				$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
				eval('$val = $P'.$fNameEval.';');
				?>
				<div class="esol-ix-settings-phpexpression" style="display: none;">
		...
		if(!$bVariable)
		{
			...
			<tr>
				<td class="esol-ix-settings-margin-container" colspan="2" id="esol-ix-conv-wrap1">
					<?
					$fName = htmlspecialcharsbx($_GET['field_name']).'[EXTRA_CONVERSION]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$arVals = array();
					if(is_array($PEXTRASETTINGS))
					{
