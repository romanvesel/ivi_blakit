...
/**
 * KDAPHPExcel_Writer_Excel5_BIFFwriter
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Writer_Excel5_BIFFwriter
{
	/**
	...
	public static function getByteOrder()
	{
		if (!isset(self::$_byte_order)) {
			...
			if ($number == $teststr) {
				...
				throw new KDAPHPExcel_Writer_Exception("Required floating point format not supported on this platform.");
			}
