...
class FieldList {
	...
	public function GetFieldsForPropMapping($IBLOCK_ID)
	{
		...
		$removeFields = array_merge($removeFields, array_map(create_function('$n', 'return "OFFER_".$n;'), $removeFields));
	...
	public function ShowSelectOfferPropertyFields($IBLOCK_ID, $fname, $value="")
	{
		...
		if($this->isSku) $OFFER_IBLOCK_ID = self::GetOfferIblock($IBLOCK_ID);
